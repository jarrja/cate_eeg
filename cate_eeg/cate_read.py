...
def edf_to_raw(edf_file_name, chan_select=[], montage_type='standard_1020'):
    # If no channel is selected, assign the default channel to the selection
    if not chan_select:
        warnings.warn('Empty selection of channel, Default channels are selected')
        # The channels are selected for CATE_EEG work
        chan_select = [u'C3', u'C4', u'O1', u'O2', u'Cz', u'F3',
                       u'F4', u'F7', u'F8', u'Fz', u'Fp1', u'Fp2', u'P3', u'P4',
                       u'Pz', u'T3', u'T4', u'T5', u'T6']
